"""command-bridge — a command bridge between a phone browser and the agent that started it."""

from importlib.metadata import PackageNotFoundError
from importlib.metadata import version as _pkg_version

try:
    __version__ = _pkg_version("command-bridge")
...
# first time it could: `pip install command-bridge` fetched 0.1.1 while `describe` reported 0.1.0,

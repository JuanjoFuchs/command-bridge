"""command_bridge.cues — short non-speech sounds that make the agent's state audible.
...
* **Padded like speech** (:func:`command_bridge.tts.pad`) because Bluetooth sinks sleep between clips and
